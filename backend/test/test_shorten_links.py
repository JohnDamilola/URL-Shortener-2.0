...
class AuthTestApp(unittest.TestCase):
    ...
    def test_create_route(self):
      ...
      with self.flask_app.app_context():
            ...
            uid=user.id
            response=self.app.post('/link/create/',json=dict(id=,user_id=uid,long_url='https://google.com',disabled=False,utm_source='test6_source',utm_medium='test6_medium',utm_campaign='test6_campaign',utm_term='test6_term',utm_content='test6_content',password_hash='link_password',expire_on=datetime.datetime(2022,11,25)))
